...
geometry: margin=1in
bibliography: sta_531_final.bib
subparagraph: yes
header-includes: |
  \usepackage{titlesec}
...
\subsection{HMM Training via Baum-Welch}
...
\subsection{Decoding - Viterbi Algorithm}
...
\subsection{Parameter Inference and Decoding Comparisons}
